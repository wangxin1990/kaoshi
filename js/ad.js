 ...
 var   timeLeft   =   45   *   60   *   1000;   
  ...
  {   
	...
	//右面
	theFloaters.addItem('followDiv1','document.body.clientWidth-106',80,'<a href=index.php?action=change_to_another_paper target=_self><img src=js/next.gif border=0></a>');
	//左面
